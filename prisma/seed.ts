...
const modulesData = [
  ...
  },
  {
    ...
    dividerTitle: null,
    iconClass: 'CircleDot',
    url: '/admin/monthly-sales-report',
    order: 30,
    parentId: 26,
  },
  {
    ...
    dividerTitle: null,
    iconClass: 'CircleDot',
    url: '/admin/daily-purchase-report',
    order: 31,
    parentId: 26,
  },
  {
    ...
    dividerTitle: null,
    iconClass: 'CircleDot',
    url: '/admin/monthly-purchase-report',
    order: 32,
    parentId: 26,
  },
  {
...
const permissionsData = [
  ...
  // Report
  { moduleId: 26, name: 'Report Access', slug: 'report-access' },
  { moduleId: 26, name: 'Report Add', slug: 'report-add' },
  { moduleId: 26, name: 'Report Edit', slug: 'report-edit' },
  { moduleId: 26, name: 'Report Delete', slug: 'report-delete' },
  { moduleId: 26, name: 'Report Bulk Delete', slug: 'report-bulk-delete' },
  ...
  { moduleId: 29, name: 'Daily Sale Access', slug: 'daily-sale-access' },
  { moduleId: 30, name: 'Monthly Sale Access', slug: 'monthly-sale-access' },
  {
    moduleId: 31,
  ...
  // Users
  { moduleId: 36, name: 'Users Access', slug: 'users-access' },
  { moduleId: 36, name: 'Users Add', slug: 'users-add' },
  { moduleId: 36, name: 'Users Edit', slug: 'users-edit' },
  { moduleId: 36, name: 'Users Delete', slug: 'users-delete' },
  { moduleId: 36, name: 'Users Bulk Delete', slug: 'users-bulk-delete' },

  // Roles
  { moduleId: 37, name: 'Roles Access', slug: 'roles-access' },
  { moduleId: 37, name: 'Roles Add', slug: 'roles-add' },
  { moduleId: 37, name: 'Roles Edit', slug: 'roles-edit' },
  { moduleId: 37, name: 'Roles Delete', slug: 'roles-delete' },
  { moduleId: 37, name: 'Roles Bulk Delete', slug: 'roles-bulk-delete' },

  // System
  { moduleId: 39, name: 'Settings Access', slug: 'settings-access' },
  { moduleId: 39, name: 'Settings Add', slug: 'settings-add' },
  { moduleId: 39, name: 'Settings Edit', slug: 'settings-edit' },
  { moduleId: 39, name: 'Settings Delete', slug: 'settings-delete' },
  { moduleId: 39, name: 'Settings Bulk Delete', slug: 'settings-bulk-delete' },

  { moduleId: 40, name: 'HRM Setting Access', slug: 'hrm-setting-access' },
  { moduleId: 40, name: 'HRM Setting Add', slug: 'hrm-setting-add' },
  { moduleId: 40, name: 'HRM Setting Edit', slug: 'hrm-setting-edit' },
  { moduleId: 40, name: 'HRM Setting Delete', slug: 'hrm-setting-delete' },
  {
    moduleId: 40,
  ...
  { moduleId: 41, name: 'Menu Access', slug: 'menu-access' },
  { moduleId: 41, name: 'Menu Add', slug: 'menu-add' },
  { moduleId: 41, name: 'Menu Edit', slug: 'menu-edit' },
  { moduleId: 41, name: 'Menu Delete', slug: 'menu-delete' },
  { moduleId: 41, name: 'Menu Bulk Delete', slug: 'menu-bulk-delete' },

  { moduleId: 42, name: 'Permission Access', slug: 'permission-access' },
  { moduleId: 42, name: 'Permission Add', slug: 'permission-add' },
  { moduleId: 42, name: 'Permission Edit', slug: 'permission-edit' },
  { moduleId: 42, name: 'Permission Delete', slug: 'permission-delete' },
  {
    moduleId: 42,
  ...
  { moduleId: 43, name: 'Customer Group Add', slug: 'customer-group-add' },
  { moduleId: 43, name: 'Customer Group Edit', slug: 'customer-group-edit' },
  {
    moduleId: 43,
  ...
  { moduleId: 44, name: 'Warehouse Access', slug: 'warehouse-access' },
  { moduleId: 44, name: 'Warehouse Add', slug: 'warehouse-add' },
  { moduleId: 44, name: 'Warehouse Edit', slug: 'warehouse-edit' },
  { moduleId: 44, name: 'Warehouse Delete', slug: 'warehouse-delete' },
  {
    moduleId: 44,
  ...
  { moduleId: 45, name: 'Brand Access', slug: 'brand-access' },
  { moduleId: 45, name: 'Brand Add', slug: 'brand-add' },
  { moduleId: 45, name: 'Brand Edit', slug: 'brand-edit' },
  { moduleId: 45, name: 'Brand Delete', slug: 'brand-delete' },
  { moduleId: 45, name: 'Brand Bulk Delete', slug: 'brand-bulk-delete' },

  { moduleId: 46, name: 'Tax Access', slug: 'tax-access' },
  { moduleId: 46, name: 'Tax Add', slug: 'tax-add' },
  { moduleId: 46, name: 'Tax Edit', slug: 'tax-edit' },
  { moduleId: 46, name: 'Tax Delete', slug: 'tax-delete' },
  { moduleId: 46, name: 'Tax Bulk Delete', slug: 'tax-bulk-delete' },

  { moduleId: 47, name: 'Unit Access', slug: 'unit-access' },
  { moduleId: 47, name: 'Unit Add', slug: 'unit-add' },
  { moduleId: 47, name: 'Unit Edit', slug: 'unit-edit' },
  { moduleId: 47, name: 'Unit Delete', slug: 'unit-delete' },
  { moduleId: 47, name: 'Unit Bulk Delete', slug: 'unit-bulk-delete' },
];
